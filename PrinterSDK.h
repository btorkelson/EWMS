...
/**
 Returns if there is iSerial-B module attached, that allows bluetooth connection to the printer
 @return TRUE if there is iSerial-B module attached, false otherwise
 **/
-(BOOL)btIsSupported;

/**
 Returns if there is active connection to the printer via bluetooth
 @return TRUE if there is an active bluetooth connection to the printer, false otherwise
 **/
-(BOOL)btIsConnected;
