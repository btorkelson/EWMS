...
-(void)putAwayPart:(EWHReceiptDetail *)receiptDetail location:(NSString *)locationName serialNumbers:(NSString *) serialNumbers user:(EWHUser *)user
{
    ...
    NSString *postData = [NSString stringWithFormat:@"{\"item\":{\"ReceiptId\":%d ,\"Id\":0,\"Number\":\"%@\",\"IsBulk\":%@,\"IsSerialized\":%@,\"Quantity\":1,\"LocationName\":\"%@\",\"LocationId\":0,\"PartNumber\":\"%@\",\"Message\":null},{\"userId\":%d}}", receiptDetail.ReceiptId, serialNumbers, receiptDetail.IsBulk ? @"true" : @"false", receiptDetail.IsSerialized ? @"true" : @"false", locationName, receiptDetail.PartNumber, user.UserId];
