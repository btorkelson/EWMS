...
@implementation EWHPutAwaySerializedPartRequest
...
//    __weak EWHRequest *sender = self;
    NSString *url = [NSString stringWithFormat:@"%@%@", super.baseURL, @"/PutAwayItem"];
//    request = [ASIHTTPRequest requestWithURL:[NSURL URLWithString:url]];
    NSString *postData = [NSString stringWithFormat:@"{\"item\":{\"ReceiptId\":%ld ,\"Id\":0,\"Number\":\"%@\",\"IsBulk\":%@,\"IsSerialized\":%@,\"Quantity\":1,\"LocationName\":\"%@\",\"LocationId\":0,\"PartNumber\":\"%@\",\"Message\":null},\"userId\":%ld}", (long)receiptDetail.ReceiptId, serialNumbers, receiptDetail.IsBulk ? @"true" : @"false", receiptDetail.IsSerialized ? @"true" : @"false", locationName, receiptDetail.PartNumber, (long)user.UserId];
