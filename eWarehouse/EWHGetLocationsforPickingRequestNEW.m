//
//  EWHGetLocationsforPickingRequestNEW.m
//  eWarehouse
//
...
@implementation EWHGetLocationsforPickingRequestNEW

-(void)getLocationsForPickingRequestNEW:(NSInteger)shipmentId withAuthHash:(NSString *)authHash
{
//    __weak EWHRequest *sender = self;
    NSString *url = [NSString stringWithFormat:@"%@%@", super.baseURL, @"/GetShipmentLocationsForPicking"];
//    request = [ASIHTTPRequest requestWithURL:[NSURL URLWithString:url]];
    NSString *postData = [NSString stringWithFormat:@"{\"shipmentId\":\"%ld\"}", (long)shipmentId];
...
//    NSError *e = nil;
        ...
        for (NSDictionary* element in [dictionary objectForKey:@"GetShipmentLocationsForPickingResult"]) {
