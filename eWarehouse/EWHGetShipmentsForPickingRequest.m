...
@implementation EWHGetShipmentsForPickingRequest

-(void)getShipmentsForPickingRequest:(NSInteger)warehouseId withAuthHash:(NSString *)authHash
{
    __weak EWHRequest *sender = self;
    NSString *url = [NSString stringWithFormat:@"%@%@", super.baseURL, @"/GetShipmentsForPicking"];
    ...
    [request setCompletionBlock:^{
        ...
        if(code == 200){
            ...
            for (NSDictionary* element in [dictionary objectForKey:@"GetShipmentsForPickingResult"]) {
