...
@implementation EWHGetShipmentDetailsForPickingRequest
...
//    __weak EWHRequest *sender = self;
    NSString *url = [NSString stringWithFormat:@"%@%@", super.baseURL, @"/GetShipmentDetailsForPicking"];
...
//    NSError *e = nil;
        ...
        NSMutableArray* shipmentDetails = [[NSMutableArray alloc] init];
                    for (NSDictionary* element in [dictionary objectForKey:@"GetShipmentDetailsForPickingResult"]) {
