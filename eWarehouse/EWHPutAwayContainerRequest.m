...
-(void)putAwayContainer:(EWHReceiptDetail *)receiptDetail location:(NSString *)locationName user:(EWHUser *)user
{
    ...
    NSString *postData = [NSString stringWithFormat:@"{\"container\":{\"ReceiptId\":%d,\"Id\":0,\"IsBulk\":%@,\"IsSerialized\":%@,\"Quantity\":0,\"LocationName\":\"%@\",\"PartNumber\":\"\",\"Message\":null,\"Number\":\"%@\"},{\"userId\":\"%d\"}}", receiptDetail.ReceiptId, receiptDetail.IsBulk ? @"true" : @"false", receiptDetail.IsSerialized ? @"true" : @"false", locationName, receiptDetail.Number, user.UserId];
