//
//  EWHGetWarehouseStorageLocations.m
//  eWarehouse
//
...
@implementation EWHGetWarehouseStorageLocations
...
//    __weak EWHRequest *sender = self;
    NSString *url = [NSString stringWithFormat:@"%@%@", super.baseURL, @"/GetWarehouseStorageLocationsList"];
//    request = [ASIHTTPRequest requestWithURL:[NSURL URLWithString:url]];
    ...
    //    NSError *e = nil;
            ...
            for (NSDictionary* element in [dictionary objectForKey:@"GetWarehouseStorageLocationsListResult"]) {
