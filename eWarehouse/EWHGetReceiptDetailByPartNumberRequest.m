...
@implementation EWHGetReceiptDetailByPartNumberRequest
...
//    __weak EWHRequest *sender = self;
    NSString *url = [NSString stringWithFormat:@"%@%@", super.baseURL, @"/GetReceiptDetailByPartNumber"];
//    request = [ASIHTTPRequest requestWithURL:[NSURL URLWithString:url]];
    NSString *postData = [NSString stringWithFormat:@"{\"receiptId\":\"%ld\",\"partNumber\":\"%@\"}", (long)receiptId, partNumber];
    ...
    //    NSError *e = nil;
            ...
            NSDictionary* details = [dictionary objectForKey:@"GetReceiptDetailByPartNumberResult"];
