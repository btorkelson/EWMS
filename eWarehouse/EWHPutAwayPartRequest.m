...
@implementation EWHPutAwayPartRequest
...
//    request = [ASIHTTPRequest requestWithURL:[NSURL URLWithString:url]];
    NSString *postData = [NSString stringWithFormat:@"{\"item\":{\"ReceiptId\":%ld ,\"Id\":0,\"Number\":\"\",\"IsBulk\":%@,\"IsSerialized\":%@,\"Quantity\":%ld,\"LocationName\":\"%@\",\"LocationId\":0,\"PartNumber\":\"%@\",\"Message\":null},\"userId\":%ld}", (long)receiptDetail.ReceiptId, receiptDetail.IsBulk ? @"true" : @"false", receiptDetail.IsSerialized ? @"true" : @"false", (long)quantity, locationName, receiptDetail.PartNumber, (long)user.UserId];
